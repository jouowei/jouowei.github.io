...
var ships = [{
    ...
    //司機名稱
var drivers = ['朱晉廷','江明峰','江國銘','呂志偉','李佳憲','林日迴','林麒雄','高自強','莊羽鴻','莊智翔','郭政峰','陳政裕',
    '陳麒任','楊文忠','韓志華','黃信銨','黃聖文','葉瑞煌','劉永富','鄭文豪','石道純','朱鎮金','吳孝豐','呂梅良','宋皇標','林豪群','洪基豪','高才述','張立威',
    '張家豪','張詠鈞','陳明光','陳朝舜','楊宗波','楊宗基','蕭麗鳳','熊勇力'];
